...
\textbf{NOTE: }Briefly describe backprop here
...
with $m$ layers, the connection of the $k^{th}$ neuron in the
...
The fundamentals equations which govern the backpropagation process
are described below.
\begin{enumerate}
\item
...
\subsubsection*{Algorithm using backpropagation}
